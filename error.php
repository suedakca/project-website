...
<head>
  ...
  <style>
    ...
    :root{
      --brand:#1d6df2;         /* favicon’daki maviye yakın */
      --brand-dark:#1555c1;
      --text:#333;
      --muted:#667085;
      --bg:#f5f7fa;
...
<div class="page-wraper">
        ...
        <div class="container">
          <div class="logo-header">
            <div class="logo-header-inner logo-header-one">
              <a href="index.html">
                <img src="images/logo-dark.png" width="171" height="49" alt="Renderlike" />
              </a>
            </div>
          </div>
  ...
  <main class="status-wrap">
    <section class="status-card" aria-labelledby="status-title">
      ...
      <h1 id="status-title" class="status-title">We’re refreshing something</h1>
      <p class="status-desc">
        Our service is temporarily unavailable while we make improvements.<br>
      ...
      <div class="hint">If the issue persists, feel free to reach out.</div>
    </section>
  </main>
