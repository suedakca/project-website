...
//============== Transparent Part ===========//	
		...
		document.querySelectorAll('.filter a').forEach(item => {
			item.addEventListener('click', function(e) {
			  e.preventDefault();
			  const filter = this.getAttribute('data-filter');
			  const items = document.querySelectorAll('.filters-data');
		  
			  items.forEach(el => {
				if (el.classList.contains(filter.substring(1))) {
		...
		document.querySelectorAll('.filter a').forEach(item => {
			item.addEventListener('click', function(e) {
			  e.preventDefault();
			  const filter = this.getAttribute('data-filter');
			  const items = document.querySelectorAll('.portfolio-post');
