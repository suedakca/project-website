...
<head>
  ...
  <link rel="canonical" href="https://renderlike.co/portfolio.php" />
  <link rel="alternate" hreflang="tr" href="https://renderlike.co/portfolio.php?lang=tr" />
  <link rel="alternate" hreflang="en" href="https://renderlike.co/portfolio.php?lang=en" />
  <link rel="alternate" hreflang="x-default" href="https://renderlike.co/portfolio.php?lang=tr" />
  ...
  <!-- PAGE TITLE HERE -->
  <title><?= __('nav_projects') ?> | Renderlike</title>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="active">
                  ...
                  <ul class="filter sub-menu mobile-about">
                    <li>
                      <a href="portfolio.php" data-filter=".interior"><?= __('about_interior') ?></a>
                    </li>
                    <li>
                      <a href="portfolio.php" data-filter=".exterior"><?= __('about_exterior') ?></a>
                    </li>
                    <li>
                      <a href="portfolio.php" data-filter=".product"><?= __('about_product') ?></a>
                    </li>
                  </ul>
                </li>
                <li>
    ...
    <div class="page-content">
      ...
      <div class="filter-cont">
        ...
        <section class="filter-old">
          <ul class="filter">
            <li class="active">
              <a href="#" data-filter=".portfolio-post"><?= __('show_all', 'Show All') ?></a>
            </li>
            <li>
              <a href="#" data-filter=".interior"><?= __('about_interior') ?>s</a>
            </li>
            <li><a href="#" data-filter=".exterior"><?= __('about_exterior') ?>s</a></li>
            <li>
              <a href="#" data-filter=".product"><?= __('about_product') ?></a>
            </li>
          </ul>
        </section>
      </div>
